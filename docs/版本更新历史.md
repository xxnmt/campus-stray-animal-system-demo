...
### 修改内容
1. **恢复头像上传逻辑至原项目版本**
   - 文件：`miniprogram/components/modifyUserInfo/modifyUserInfo.js`、`miniprogram/utils/common.js`、`miniprogram/utils/user.js`、`functionsEMAS/unionOp/userOp.js`、`miniprogram/pages/info/userInfo/userInfo.js`
   - 移除所有多余的 URL 清理逻辑
   - 移除图片压缩功能
